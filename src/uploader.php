...
class XoopsMediaUploader
{
	...
	/**
	 * Temp name after the file was uploaded
	 *
	 * @var string
	 */
	public $mediaTmpName;
	...
	/**
	 * Was there an error in media type or name
	 *
	 * @var string
	 */
	public $mediaError;
	...
	/**
	 * Saved Destination after upload
	 *
	 * @var string
	 */
